...
- Change doc_auto_cfg to doc_cfg ([#26](https://github.com/jonathan-g-davis/schwab-sdk/pull/26))

## [0.4.0](https://github.com/jonathan-g-davis/schwab-sdk/compare/v0.3.0...v0.4.0) - 2026-05-29

### Added

- Accessors on OrderRequest ([#25](https://github.com/jonathan-g-davis/schwab-sdk/pull/25))
- [**breaking**] Impl TryFrom<Order> for OrderRequest ([#24](https://github.com/jonathan-g-davis/schwab-sdk/pull/24))
- [**breaking**] Orders accept integer quantities ([#22](https://github.com/jonathan-g-davis/schwab-sdk/pull/22))
- Re-export dec! macro ([#21](https://github.com/jonathan-g-davis/schwab-sdk/pull/21))
